package frame.starter.swagger.autoconfigure;

import com.google.common.base.Predicate;
import frame.starter.swagger.configuration.SwaggerBeanValidatorPluginsConfiguration;
import frame.starter.swagger.configuration.SwaggerSecurityFilterPluginsConfiguration;
import frame.starter.swagger.properties.SwaggerProperties;
import frame.starter.swagger.properties.SwaggerSecurityProperties;
import frame.starter.swagger.security.GlobalAccess;
...
/**
 * @Auther: 影风
 * @Date: 2018/7/6 上午9:16
 * @Description: Swagger自动装载类
 */
@Configuration
...
public class SwaggerAutoConfiguration implements BeanFactoryAware {
    ...
    public List<Docket> createRestApi(SwaggerProperties swaggerProperties, GlobalAccess globalAccess) {
        ...
        if (swaggerProperties.getGroups().size() == 0) {
            ...
            // exclude-path 处理
            List<Predicate<String>> excludePath = newArrayList();
